...
class QtHelperTests(unittest.TestCase):
    def test_qt_app_title_includes_version(self):
        ...
        self.assertEqual(qt.APP_VERSION, "0.1.2")
        self.assertEqual(qt.app_title(), "Calibre Meta Edit 0.1.2")
    ...
    def test_statusbar_text_contains_ready_calibre_csv_and_version(self):
        ...
        self.assertEqual(text, "Ready | Calibre vypnuto | matches.csv nacteno | 0.1.2")
